...
| 1-3e | ~~**アセットパックの選定**~~ → **買わずに [assets/avatar.blend.py](../../assets/avatar.blend.py) で生成することにした。**アバターは完了（3体型・18ボーン・3クリップ・テクスチャ0）。建材と家具は未着手 | [10 §6](./10-assets.md)。自前生成なので商用可・改変可・**再配布可**を自動的に満たす |
