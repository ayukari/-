...
| 1-3c | **3D ビュー実装**（Three.js、影なし、固定カメラ） → **[client/src/render3d.js](../../client/src/render3d.js) が動作**。プリミティブのみで、ベイク済みアセットは 1-3e 待ち | M-03, [04 §4.6](./04-architecture.md), [10](./10-assets.md) |
