...
| 1-3c | ~~**3D ビュー実装**（Three.js、影なし、固定カメラ）~~ → **[client/src/render3d.js](../../client/src/render3d.js) が動作**。アバターは glTF、建材・家具はまだプリミティブ | M-03, [04 §4.6](./04-architecture.md), [10](./10-assets.md) |
| 1-3e | ~~**アセットパックの選定**~~ → **買わずに [assets/avatar.blend.py](../../assets/avatar.blend.py) で生成することにした。**アバターは完了（**83パーツ・13万通り**・18ボーン・3クリップ・テクスチャ0）。建材と家具は未着手 | [10 §6](./10-assets.md)。自前生成なので商用可・改変可・**再配布可**を自動的に満たす |
